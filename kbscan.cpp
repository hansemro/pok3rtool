...
#define CM_PRO_M_RGB_PID        0x004d
#define CM_PRO_M_RGB_BOOT_PID   0x004e
#define CM_PRO_L_RGB_PID        0x003b
#define CM_PRO_L_RGB_BOOT_PID   0x003a
...
//  { DEV_KBP_V100,         { "kbp/100",            "KBP V100",                 HOLTEK_VID, KBP_V100_PID,       BOOT_PID | KBP_V100_PID,        PROTO_POK3R,    FW_ADDR_2C00 } },
    ...
    { DEV_CM_PRO_M_RGB,     { "cm/promrgb",         "MasterKeys Pro M RGB",     CM_VID,     CM_PRO_M_RGB_PID,   CM_PRO_M_RGB_BOOT_PID,          PROTO_CYKB,     FW_ADDR_3400 } },
    { DEV_CM_PRO_L_RGB,     { "cm/prolrgb",         "MasterKeys Pro L RGB",     CM_VID,     CM_PRO_L_RGB_PID,   CM_PRO_L_RGB_BOOT_PID,          PROTO_CM,       FW_ADDR_3400 } },
